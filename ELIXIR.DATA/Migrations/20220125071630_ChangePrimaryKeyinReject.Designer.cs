...
namespace ELIXIR.DATA.Migrations
{
    ...
    [Migration("20220125071630_ChangePrimaryKeyinReject")]
    partial class ChangePrimaryKeyinReject
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ELIXIR.DATA.DATA_ACCESS_LAYER.MODELS.QC_MODEL.PO_Reject", b =>
                {
                    b.HasOne("ELIXIR.DATA.DATA_ACCESS_LAYER.MODELS.QC_MODEL.PO_Receiving", "PO_Receiving")
                        .WithMany()
                        .HasForeignKey("PO_ReceivingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PO_Receiving");
                });
